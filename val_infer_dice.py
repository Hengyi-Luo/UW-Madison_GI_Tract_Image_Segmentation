...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--weights", type=str, default="outputs/20260206-212313_Unet3D_c1/best.pt")
    p.add_argument("--val_ids", type=str, default="inputs/splits/c1_val_case_days.csv")
    p.add_argument("--out_per_case", type=str, default="outputs/20260206-212313_Unet3D_c1/val_eval/eval_per_case.csv")
    p.add_argument("--out_summary", type=str, default="outputs/20260206-212313_Unet3D_c1/val_eval/eval_summary.json")
