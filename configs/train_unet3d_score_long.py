...
# model
cfg.model_name = "Unet3D_score_long"
cfg.spatial_dims = 3
cfg.in_channels = 1
cfg.out_channels = 3
...
# loss
cfg.loss_name = "dicebce"
cfg.loss_lambda_dice = 0.5
cfg.loss_lambda_ce = 0.5
...
cfg.early_stop_metric = "val/dice_sw_mean"
cfg.early_stop_mode = "max"
cfg.early_stop_min_epochs = 120
cfg.early_stop_patience = 12
cfg.early_stop_min_delta = 0.0003
